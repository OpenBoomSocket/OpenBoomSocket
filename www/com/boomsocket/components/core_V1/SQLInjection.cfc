...
If you feel this message has been reached in error and the data you submited is in fact valid, please contact us at: support [at] d [dash] p [dot] com.">
			...
			<CFIF VARIABLES.abuseEmailString NEQ "" AND ReFind("[_a-zA-Z0-9-]+(\.[_a-zA-Z0-9-]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*\.(([0-9]{1,3})|([a-zA-Z]{2,3})|(aero|coop|info|museum|name))", VARIABLES.abuseEmailString) NEQ "0">
				<CFMAIL FROM="support@d-p.com" TO="#VARIABLES.abuseEmailString#" SUBJECT="SQL Injection Details - #VARIABLES.injectionId#" TYPE="HTML">
					<HTML>
					<BODY>
					...
					<p>
					Digital Positions, Inc.<br>
					2289 Peachtree Rd. NE<br>
					Atlanta, GA 30309<br>
					404-351-2366<br>
					support@d-p.com<br>
					</p>
			...
			<CFMAIL FROM="support@d-p.com" TO="support@d-p.com" SUBJECT="SQL Injection Details - #VARIABLES.injectionId#" TYPE="HTML">
				<HTML>
				<BODY>					
