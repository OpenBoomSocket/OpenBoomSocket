...
<cfparam name="attributes.title" default=":: boomsocket ::">
...
<cfif thistag.executionmode is "START">
	<cfif request.needsHeader>
		...
		<head>
			...
			<cfinclude template="/css/navigation/adminstyles.cfm">
		...
		<body style="margin: 0px" onload="#attributes.onload#">
			...
			<cfswitch expression="#LCase(attributes.admintemplate)#">
				...
				<cfdefaultcase>
					...
					<div id="mainShell">
						<div id="header">
							<div id="textNav"><cfoutput><a href="/admintools/index.cfm?i3displayMode=help">help</a> | <a href="http://www.d-p.com/home/Contact-Digital-Positions.cfm?clientcode=#application.sitemapping#" target="_blank">contact dp</a> | <a href="#application.installurl#/" target="_blank">live site</a> | <a href="login.cfm?logout=yes" target="_top">log out</a></cfoutput></div>
		...
		<cfif request.needsFooter>
			...
			<cfswitch expression="#LCase(attributes.admintemplate)#">
				...
				<cfdefaultcase>
						...
						<div id="footer">
							All content &copy; 2006-<cfoutput>#DateFormat(now(),'yyyy')#</cfoutput> <a href="http://www.d-p.com" target="_blank">Digital Positions</a>
						</div>
				</cfdefaultcase>
			</cfswitch>	
