<!--- 
Authors: Ben Wakeman, George McLin, Carla Romaine
Company: Digital Positions
Date: 12/11/2002
Modified: 12/2006 DRK added content mapping and composite form functionality
Purpose: Custom tag designed to wrap form data into an XML object --->
...
<table id="sockebuildertable" width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<cfif isDefined('FORM.useMappedContent') AND (form.inputtype EQ "useMappedContent")><input name="inputtype" id="inputtype" type="hidden" value="useMappedContent" /></cfif>
          ...
          <option value="bs_pageTitle"<cfif form.inputtype EQ "bs_pageTitle"> SELECTED</cfif>>boomsocket Page Title</option>
