...
<CFOUTPUT><SELECT NAME="#Attributes.Name1#" ID= "#Attributes.Id1#" onChange="#FunctionName#" SIZE="#Attributes.Size1#" <CFIF Attributes.Width1 is not "">STYLE="width:#Attributes.Width1#"</CFIF>></CFOUTPUT>
...
<CFOUTPUT><SELECT NAME="#Attributes.Name2#" <cfif Attributes.multiple EQ true> MULTIPLE= "MULTIPLE" </cfif> ID="#Attributes.Id2#" SIZE="#Attributes.Size2#" <CFIF Attributes.onChange is not "">onChange="#Attributes.OnChange#"</CFIF> <CFIF Attributes.Width2 is not "">STYLE="width:#Attributes.Width2#"</CFIF>></CFOUTPUT>
	<!--- SPECIAL FIRST ITEM, IF REQUESTED --->
