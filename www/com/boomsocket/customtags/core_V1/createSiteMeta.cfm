...
<cfset siteMetaDir="#application.installPath#\meta">
...
<!--- delete all meta files in siteMetaDir --->
<cfdirectory action="LIST"
             directory="#siteMetaDir#"
             name="metaDirList"
             filter="*.cfm">
<cfloop query="metaDirList">
	<cfset thisMetaFile="#siteMetaDir#\#metaDirList.name#">
...
<cfset thisNewMetaFileName="#siteMetaDir#\#sitesectionid#_#pageid#_#pagename#">
...
<meta name="Code-Copyright" content="#dateFormat(Now(),"yyyy")#, Digital Positions, Inc. - 404-351-2366" />
<meta name="System" content="Powered by boomsocket : http://www.boomsocket.com" />
