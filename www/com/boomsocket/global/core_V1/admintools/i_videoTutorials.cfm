...
<div id="helpDocs"><a href="#application.globalPath#/helpDocs/boomsocket_user_docs.pdf" target="_blank"><img src="#application.globalPath#/media/images/icon_pdf.gif" border="0" width="14" height="15"/></a> Download the <a href="#application.globalPath#/helpDocs/boomsocket_user_docs.pdf" target="_blank">boomsocket help docs</a></div>
	...
	<div class="helpLeftContainer">	
    	<cfif q_getHelpVideos.recordcount>
			<div class="helpLeftContentContainer">
                ...
                <div class="helpContent">Check out the guided tutorials...</div>
                <ul>
                   <cfloop query="q_getHelpVideos">
                        <li><a href="#application.globalPath#/helpDocs/videoTutorials.cfm?video=#q_getHelpVideos.videoPath#" target="_blank">#q_getHelpVideos.uploadtitle#</a></li>
                    </cfloop>
                </ul>
        ...
        <div class="helpLeftContentContainer">
            ...
            <div class="helpContent">Browse the glossary to familiarize yourself with terms and concepts central to understanding boomsocket, Content Management and web sites in general.</div>
            <div class="viewLink"><a href="#request.page#?adminPage=glossary.cfm">View Glossary </a></div>
        </div>	
        <div class="helpLeftContentContainer">
            <div class="helpHeader">boomsocket FAQs</div>
            <div class="helpContent">Got questions? We are quickly building a knowledge base to better answer any questions that you may have as you begin to use boomsocket. Soon you will have the ability to submit a question if you cannot find it here.</div>
            <div class="viewLink"><a href="#request.page#?adminpage=faqs.cfm">View FAQs</a></div>
        </div>
        <cfif url.searchresults>
            <div class="helpLeftContentContainer">
                <div class="helpHeader">Tips</div>
                <div class="helpContent">Want to get some tips on tricks on how to use boomsocket quickly and effectively?  Head over to our tips section which is always growing.</div>
    ...
    <cfif url.searchresults><!--- search results--->
        <div class="helpRightContentContainer">
            ...
            <div style="margin-bottom:10px; text-align:right;"><a href="#request.page#?i3displayMode=help"><b>Search Again</b></a></div>
                    ...
                    <div class="helpContent"><strong>boomsocket FAQs:</strong><br />
    ...
    <cfelse><!--- search form--->
        <div class="helpRightContentContainer">
            ...
            <div class="helpContent">
                <div id="searchinst" style="margin-bottom:10px">To search the glossary, boomsocket FAQS, and tips submit the form below:</div>
        ...
        <div class="helpRightContentContainer">
            <div class="helpHeader">Tips</div>
            <div class="helpContent">Want to get some tips on tricks on how to use boomsocket quickly and effectively?  Head over to our tips section which is alwayg growing.<br /><br /></div>
            <div class="viewLink"><a href="#request.page#?adminpage=tips.cfm">View Tips</a></div>
        </div>
    </cfif>
    </div>
