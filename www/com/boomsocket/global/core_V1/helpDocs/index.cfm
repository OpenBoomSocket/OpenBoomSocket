	...
	<div class="helpLeftContainer">	
    	<cfif q_getHelpVideos.recordcount>
			<div class="helpLeftContentContainer">
                ...
                <div class="helpContent">Video tutorials are a great way to learn to use the boomsocket site management system in a fast visual medium. Click on any of the links below to open the tutorial.</div>
