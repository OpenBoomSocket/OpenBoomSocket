...
<cfcomponent output="yes">
	...
	<cffunction name="exportFiles" access="public" returntype="string">
		...
		<cftry>
			...
			<cfset creatorNode.xmlText = "Open BoomSocket">
	...
	<!--- copy files from plugin directory ---><!--- EOM :: NOTE :: This function is reponsible for the copying (and renamin) of files in socket folder into the local Open BoomSocket site instiallion.--->
	<!--- TABLENAME.cfc, dh_TABLENAME.cfm, i_TABLENAME.cfm[, TABLENAME.css] --->
