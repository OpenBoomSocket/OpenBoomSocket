...
<div>
	<div class="helpLeftContainer">	
        ...
        <div class="helpLeftContentContainer">
            ...
            <div class="helpContent">Browse the glossary to familiarize yourself with terms and concepts central to understanding v, Content Management and web sites in general.</div>
        ...
        <cfif url.searchresults>
            <div class="helpLeftContentContainer">
                ...
                <div class="helpContent">Want to get some tips on tricks on how to use v quickly and effectively?  Head over to our tips section which is always growing.</div>
    ...
    <cfif url.searchresults><!--- search results--->
        <div class="helpRightContentContainer">
            ...
            <div style="margin-bottom:10px; text-align:right;"><a href="#request.page#?i3displayMode=help"><b>Search Again</b></a></div>
                    ...
                    <div class="helpContent"><strong>v FAQs:</strong><br />
