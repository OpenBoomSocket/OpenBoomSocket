		...
		<table>
			<tr>
				...
				<td class="formiteminput" width="70%"><select name="formEnvironmentID" size="1">
						...
						<option value="104">Open BoomSocket Admin (Core)</option>
						<option value="105">Open BoomSocket Admin (Core/NoDB)</option>
						<option value="106">Open BoomSocket Admin (Core/SiteSection/Page)</option>
						<option value="108">Open BoomSocket Admin (Custom No Filter)</option>
						<option value="102">Open BoomSocket Admin (Custom)</option>
						<option value="107">Open BoomSocket Admin (Custom/No DB)</option>
						<option value="111">Open BoomSocket Admin (Flex - requires CF 7.0.2+)</option>
					</select>
				</td>
			</tr>
			<tr>
