...
if ( hasProductInstall && !hasRequestedVersion ) {
	...
	AC_FL_RunContent(
			"src", "/admintools/media/swf/ContentMapping",
			"width", "100%",
			"height", "100%",
			"align", "middle",
			"id", "ContentMapping",
