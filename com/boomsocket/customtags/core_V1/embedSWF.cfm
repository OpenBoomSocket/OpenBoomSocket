<!--- 
	...
	ATTRIBUTES :::
				  ...
				  :: AC_RunActiveContent_file    :::: DEFAULT = AC_RunActiveContent.js      :::: URL to AC_RunActiveContent.js file in current directory.  In Open BoomSocket, add this file in admintool's javascript Toolbox
--->
<cfsilent>
